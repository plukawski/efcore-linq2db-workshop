...
namespace NorthwindDataAccess
{
    ...
    {
        private readonly NorthwindCommandInterceptor interceptor;

        public NorthwindContext(NorthwindCommandInterceptor interceptor)
        {
            this.interceptor = interceptor;
        }

        public NorthwindContext(DbContextOptions<NorthwindContext> options, NorthwindCommandInterceptor interceptor)
            : base(options)
        {
            this.interceptor = interceptor;
        }
        ...
        public virtual DbSet<PagingResultsWithTotalCount> PaginResultsWithTotalCount { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PagingResultsWithTotalCount>(entity =>
            {
                entity.HasNoKey();
            });
